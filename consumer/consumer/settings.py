...
SECRET_KEY = 'django-insecure-%@&8#(rswdkw7@36$2!^_y4825ly5a$g5f6q6my)kyxz@v(w@4'
...
if DEVELOPMENT:
    ...
    DB_HOST = "mongodb_consumer"
    REDIS_HOST = "cache_consumer"
...
ASGI_APPLICATION = 'consumer.routing.application'
